...
import { Calendar, Award, Users, BookCheck } from "lucide-react";
...
export default function EventsStats() {
  ...
  const stats = [
    { icon: Calendar, val: language === "bn" ? "১০০+" : "100+", label: t("events_stat_total") },
    { icon: Award, val: language === "bn" ? "১৫+" : "15+", label: t("events_stat_upcoming") },
    { icon: Users, val: language === "bn" ? "৫,০০০+" : "5,000+", label: t("events_stat_participants") },
    { icon: BookCheck, val: language === "bn" ? "৩,৫০০+" : "3,500+", label: t("events_stat_certificates") },
  ];
