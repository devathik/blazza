...
interface GalleryFilterBarProps {
  ...
  onCategoryChange: (cat: GalleryCategory) => void;
  searchQuery: string;
...
export default function GalleryFilterBar({
  ...
  const categories: { id: GalleryCategory; label: string }[] = [
    ...
    { id: "seminars", label: t("gallery_filter_seminars") },
    { id: "conferences", label: t("gallery_filter_conferences") },
    { id: "camps", label: t("gallery_filter_camps") },
    { id: "videos", label: t("gallery_filter_videos") },
  ];
    ...
    <div className="space-y-4 mb-8">
      ...
      <div className="flex items-center justify-between text-xs text-muted-foreground px-1">
        <div className="flex items-center gap-1.5 font-medium">
          ...
          <span>
            {language === "bn"
              ? `প্রদর্শিত হচ্ছে: ${resultCount} টি আইটেম`
