...
import { ChapterCategory } from "../types/chapter.types";

interface ChaptersFilterBarProps {
  activeCategory: ChapterCategory;
  onCategoryChange: (cat: ChapterCategory) => void;
  searchQuery: string;
  onSearchChange: (query: string) => void;
  resultCount: number;
}

export default function ChaptersFilterBar({
  activeCategory,
  onCategoryChange,
  searchQuery,
  onSearchChange,
  ...
  const categories: { id: ChapterCategory; label: string }[] = [
    { id: "all", label: t("chapters_filter_all") },
    { id: "district", label: t("chapters_filter_district") },
    { id: "university", label: t("chapters_filter_university") },
  ];
    ...
    <div className="space-y-4 mb-8">
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
        ...
        <div className="relative min-w-[240px]">
          ...
          <input
            ...
            placeholder={t("chapters_search_placeholder")}
      ...
      <div className="flex items-center justify-between text-xs text-muted-foreground px-1">
        <div className="flex items-center gap-1.5 font-medium">
          ...
          <span>
            {language === "bn"
              ? `প্রদর্শিত হচ্ছে: ${resultCount} টি শাখা`
